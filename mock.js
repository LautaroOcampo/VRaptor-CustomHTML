...
const dataMock = {
  header: {
    logo: 'https://http2.mlstatic.com/storage/mshops-appearance-api/images/81/1020578981/logo-2022031413221155000.png',
    name: 'Test Shop',
    home_url: '',
    flash: {
      enabled: true,
      message: "USALOS COMO QUIERAS, CUANDO QUIERAS, DONDE QUIERAS, V-Raptor® 🇦🇷",
      tooltip_message: "",
      trigger_message: "",
      action: {
        message: "",
  ...
  footer: {
    logo: 'https://http2.mlstatic.com/storage/mshops-appearance-api/images/81/1020578981/logo-2022031413221155000.png',
    name: 'Test Shop',
    logoCaption: '<p>Apostamos a la produccion nacional para REVALORIZAR LA INDUSTRIA ARGENTINA y dar nuevas fuentes de trabajo.De Argentina al Mundo.V-Raptor®,Usalos cómo quieras, cuándo quieras, dónde quieras.</p>',
    ...
    fiscalData: {
      ...
      qr_img: 'https://http2.mlstatic.com/frontend-assets/mshops-web-home/afip-qr.jpeg', // just AR
